...
CREATE TABLE `felhasznalok` (
  ...
  `Nev` varchar(45) CHARACTER SET utf8mb4  NOT NULL,
  `Jog` varchar(45) CHARACTER SET utf8mb4  NOT NULL,
  `Felhasznalonev` varchar(45) CHARACTER SET utf8mb4  NOT NULL,
  `Jelszo` varchar(45) CHARACTER SET utf8mb4  NOT NULL,
  `Telefonszam` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
...
CREATE TABLE `szamlak` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Elado` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Cikkszam` longtext CHARACTER SET utf8mb4 ,
  `Termek` longtext CHARACTER SET utf8mb4 ,
  `Osszeg` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Fizetett` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Visszajaro` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Vasarlo` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
...
CREATE TABLE `termekek` (
  ...
  `Tipus` longtext CHARACTER SET utf8mb4  NOT NULL,
  `Keszleten` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Ar` int NOT NULL,
...
CREATE TABLE `vasarlok` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Nev` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Vallalkozasneve` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Vasarloid` int NOT NULL,
  `Cim` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Orszag` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Varos` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Iranyitoszam` varchar(45) COLLATE utf8_hungarian_ci DEFAULT NULL,
  `Telefonszam` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Email` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  `Ugyintezo` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`),
...
-- Dump completed on 2021-04-21  1:31:20
